                  ...
                  <div class="investMain">
                      ...
                      <div class="investContent">
                          <div class="investOver clearfix" id = "banks2">
                              <form id="alipayRechargeForm" action="${pageContext.request.contextPath}/loan/alipayToRecharge" method="post" target="_blank">
                              ...
                              <form id="wxpayRechargeForm" action="${pageContext.request.contextPath}/loan/wxpayToRecharge" method="post" target="_blank">
